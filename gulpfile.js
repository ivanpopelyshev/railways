...
global.paths = {
    ...
    src_styles: './src/less',
    out: './public/bin',
    out_styles: './public/css',
    test: './test',

    get scripts() { return this.src + '/**/*.js'; },
    get tests  () { return this.test + '/**/*.test.js'; },
    get jsEntry() { return this.src + '/ui/app'; },
    get workerEntry() { return this.src + '/game/worker'; },
    get lessEntry() { return this.src + '/less/main.less'; },
    get styles() { return this.src + '/less/*.less'; }
};
